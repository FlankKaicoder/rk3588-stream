...
int main(int argc, char **argv)
{
    ...
    // 04-3 experiment:
    // Ask OpenCV/GStreamer mplane plugin to output 1280x720 frames directly.
    // On RKISP, cap.get() may still report 3840x2160, so final frame.shape is more reliable.
    ...
    while (frame_count < max_frames)
    {
        ...
        bool read_ok = cap.read(frame_720p);
        ...
        // In 04-3, frame_720p is already captured as 1280x720.
        // No OpenCV resize is needed.
        ...
        // 04-3-nowrite experiment:
        // skip VideoWriter.write() to measure capture + preprocess + model + draw only
