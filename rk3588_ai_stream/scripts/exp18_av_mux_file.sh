...
MUX_COPY="$OUT_DIR/detect_with_audio_copy.mp4"
MUX_REENC_AAC="$OUT_DIR/detect_with_audio_reenc_aac.mp4"
MUX_SHORT="$OUT_DIR/detect_with_audio_shortest.mp4"

AUDIO_GAIN="$OUT_DIR/audio_gain12db.m4a"
MUX_GAIN="$OUT_DIR/detect_with_audio_gain12db.mp4"
